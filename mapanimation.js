...
mapboxgl.accessToken =
  "pk.eyJ1Ijoic3RoaXJ1bWEiLCJhIjoiY2x0a2IyczIzMTBsYjJrcWhnbGhvZmVsbyJ9.0U5kp6pknvdSx_5Jfzocrw";
...
function move() {
  ...
  // Make sure you call move() after you increment the counter.
    setTimeout(() => {
        ...
        if (counter == 12) {
            marker.remove();
            marker = new mapboxgl.Marker({ "color": "#b40219" }) //this changes color to a dark red
